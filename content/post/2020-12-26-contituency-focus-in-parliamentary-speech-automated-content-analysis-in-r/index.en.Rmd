---
title: 'Contituency-Focus in Parliamentary Speech: Automated Content Analysis in R'
author: admin
date: '2020-12-26'
slug: contituency-focus-in-parliamentary-speech-automated-content-analysis-in-r
categories: []
tags:
  - content analysis
  - r
...
summary: ''
authors: []
lastmod: '2020-12-26T17:54:44Z'
featured: yes
image: "~/Desktop/hugo/content/post/2020-12-26-contituency-focus-in-parliamentary-speech-automated-content-analysis-in-r"
  caption: ''
  focal_point: ''
  preview_only: no
projects: []
...
## group_by andd summarise from dplyr package
...
df <- subset(df, count >= 50 & count <= 2000)
